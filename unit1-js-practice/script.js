...
let squarePerimiter = 4 * side;
let circleArea = Math.PI * radius * radius;
let circlePerimeter = 2 *Math.PI * radius;


console.log("The square area is " + squareArea + " and the perimeter is " + squarePerimiter);
...
// const hours = `Time: ${new Array(parseFloat(time)).fill("/").join('')}`;
// const costBar = `Cost: ${new Array(parseFloat(cost)).fill("$").join('')}`;
